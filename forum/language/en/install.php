...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'			=> 'DSN stands for Data Source Name and is relevant only for ODBC installs. On PostgreSQL, use localhost to connect to the local server via UNIX domain socket and %HOST% to connect via TCP. For SQLite, enter the full path to your database file.',
