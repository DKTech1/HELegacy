...
?>
    ...
    public function sendGreetingMail(){
        ...
        $from = 1;
        $type = 1;
        $subject = _('Welcome to HackerGuilds!');
        $text = sprintf(_('Greetings, %s!<br/><br/>Thanks for trying out HackerGuilds, we are very excited to have you on board. Congratulations on completing the tutorial. It wasn\'t that hard, right? <br/><br/>There are <strong>a lot</strong> more things to do in the game, if you get stuck don\'t hesitate in talking to us.<br/><br/>The fastest way of getting help is posting at our <a href="http://forum.HackerGuilds.com/">community board</a>. We will happly guide you through the game. You can also find a great resource information on our <a href="http://wiki.HackerGuilds.com/">Wiki page</a>.<br/>Replying to this mail is another option. I\'d be thrilled to talk to you :)<br/><br/>(By the way, I just sent you 1.337 BTC. You can see it on the Finances page. Enjoy!)<br/><br/>Pardon the pun, but we hope you have a great <i>experience</i> here!!<br/><br/>Happy hacking!<br/>Renato.'), $this->player->getPlayerInfo($_SESSION['id'])->login);
