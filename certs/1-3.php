...
<br/>
<br/>
<?php echo _('If you prefer, you can mail us at'); ?> <code><?php echo _('contact@HackerGuilds.com'); ?></code>.<br/>
        ...
        <div class="span5">
            <div class="widget-box">
                ...
                <div class="widget-content center">
                    ...
                    <a href="https://wiki.HackerGuilds.com">https://wiki.HackerGuilds.com/</a>
                    <br/>
                    <br/>
                    <strong><?php echo _('Forum'); ?></strong><br/>
                    <a href="https://forum.HackerGuilds.com">https://forum.HackerGuilds.com/</a>
                </div>
            </div>
        </div>
    </div>
